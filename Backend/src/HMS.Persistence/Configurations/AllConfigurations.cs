...
internal sealed class PatientIntakeConfiguration : IEntityTypeConfiguration<PatientIntake>
{
    public void Configure(EntityTypeBuilder<PatientIntake> b)
    {
        ...
        b.Property(i => i.VisitType);
        b.Property(i => i.Priority);
        b.Property(i => i.ArrivalMethod);
        ...
        {
            ec.ToTable("IntakeEmergencyContacts");
...
internal sealed class VisitConfiguration : IEntityTypeConfiguration<Visit>
{
    public void Configure(EntityTypeBuilder<Visit> b)
    {
        ...
        b.Property(v => v.VisitType);
        b.Property(v => v.Priority);
        b.Property(v => v.ArrivalMethod);
        b.Property(v => v.ChiefComplaint).HasMaxLength(1000);
        b.Property(v => v.Notes).HasMaxLength(4000);
        b.Property(v => v.PayerType);
