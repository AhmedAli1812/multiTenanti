        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArrivalMethod = table.Column<int>(type: "int", nullable: false),
                    ...
                    InsuranceJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Floors_Branch_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Visits_Branch_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branch",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Intakes_TenantId",
                table: "Intakes",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_Patients_MedicalNumber_TenantId",
                table: "Patients",
                columns: new[] { "MedicalNumber", "TenantId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomAssignments_IsActive",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomAssignments_VisitId",
                table: "RoomAssignments",
                column: "VisitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_RoomNumber_BranchId_TenantId",
                table: "Rooms",
                columns: new[] { "RoomNumber", "BranchId", "TenantId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_PhoneNumber_TenantId",
                table: "Users",
